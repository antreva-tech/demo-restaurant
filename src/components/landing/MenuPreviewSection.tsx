...
/** Max categories and items per category to show in the brief summary. */
const MAX_CATEGORIES = 5;
const MAX_ITEMS_PER_CATEGORY = 6;

/**
 * Brief menu summary on the home page: categories and items with prices.
 * Data from getPublicMenu / getDefaultPublicMenu. CTA links to the full menu.
 */
    ...
    <section className="border-y border-menu-gold/20 bg-gray-50/80 px-4 py-12 sm:py-16" aria-labelledby="menu-preview-heading">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-2 text-center text-gray-600">
          Echa un vistazo a nuestros platos y precios.
        </p>
        ...
        <div className="mt-12 flex flex-col items-center">
          ...
          <p className="mt-3 text-center text-sm text-gray-500">
            Elige, añade al pedido y paga en línea.
          </p>
        </div>
      </div>
    </section>
